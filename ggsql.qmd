...
# NOTES TO SELF
1. i'm not consistent about bold/highlight of some of the words throughout: ggsql, R, Python, even CONSOLE vs Console...
...
5. As far as I can tell, if you set up the Quarto doc to have a knitr engine, there is no connection to `{ggsql}` chunks at all.
