...
<span class="kw">REFERENCES</span> <span class="fn">students</span>(student_id);
  ...
  <div class="sticky-right">
    ...
    <div class="step" data-panel="1-0">
      ...
      <h3>SQL has multiple dialects</h3>
      <p> SQL has five main dialects: PostgreSQL, MySQL, T-SQL (Microsoft SQL Server), PL/SQL (Oracle), and SQLite. There are small nuances between these dialects, both in querying syntax and in data storage structures. For people getting started with relational databases, MySQL is generally regarded as the most user-friendly option because of its forgiving syntax and large ecosystem of tools for beginners. </p>
    ...
    <div class="sticky-panel active" id="panel-3-tree">
      <div style="width:100%;display:flex;flex-direction:column;gap:0.8rem;">
        ...
        <div style="font-size:0.75rem;color:#5b6b86;line-height:1.5;background:#eef3fe;border-radius:8px;padding:0.6rem 0.8rem;border:1px solid #b6c9ee;">
          Root node (top) → branch nodes (middle) → leaf nodes (bottom, linked in sorted order). Photo credit: <a href="references.qmd" target="_blank" style="color:#5b6b86;text-decoration:underline;">(Winand, 2026)</a>
        </div>
      </div>
    </div>
